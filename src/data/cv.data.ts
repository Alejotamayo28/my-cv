...
export const cvData: CvData = {
  ...
  summary: "Backend Developer con experiencia en sistemas en producción (Node.js, TypeScript, PostgreSQL, Docker, AWS). He diseñado y optimizado APIs REST/gRPC, bases de datos relacionales y flujos de despliegue automatizados. Busco aportar mis habilidades en microservicios y cloud a equipos dinámicos de alto impacto",
  experience: [
    {
    ...
    },
    {
      ...
      achievements: [
        ...
        "Automatizé instalación de Docker, ejecución de contenedores y monitoreo con CloudWatch, eliminando errores manuales.",
